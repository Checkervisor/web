    ...
    <div className="flex flex-col gap-y-31">
      ...
      <div className="flex flex-row gap-x-10 items-center">
        ...
        <div className="flex flex-col gap-y-3 font-extrabold">
          ...
          <p className="text-xl">Checkervisor is a professional Legit Checker</p>
          <p className="text-xl">
      ...
      <div className="grid grid-cols-4 gap-x-8 font-semibold text-center">
        <div className="statistic-box">
          <span style={{ left: 10, top: -22 }} className="statistic-label bg-black">
            We&apos;ve checked
          </span>
        ...
        <div className="statistic-box">
          <span style={{ left: 10, top: -22 }} className="statistic-label bg-greenCV">
            Authentic
          </span>
        ...
        <div className="statistic-box">
          <span style={{ left: 10, top: -22 }} className="statistic-label bg-redCV">
            Item Fake
          </span>
